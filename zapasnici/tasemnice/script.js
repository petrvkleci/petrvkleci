const fighterData = {
    ...
    methods: { ko: 0, sub: 0, dec: 2, xx: 0 }, 

    recentFights: [
        { result: "loss",    opponent: "Dejví Čedar",   method: "Na body",         round: "2. kolo", event: "Petr v Kleci 5", date: "5. 5. 2026" },
        { result: "win",     opponent: "David Houser",  method: "Na body",         round: "2. kolo", event: "Petr v Kleci 3", date: "14. 12. 2025"}
    ]
};
